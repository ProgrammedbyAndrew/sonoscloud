...
#MONDAY
    ...
    schedule.every().friday.at("21:00").do(run_script, script="85fm.py")  # 4:00 PM EST
    schedule.every().friday.at("21:15").do(run_script, script="85ad.py")  # 4:15 PM EST
    schedule.every().friday.at("21:30").do(run_script, script="85fm.py")  # 4:30 PM EST
    schedule.every().friday.at("21:45").do(run_script, script="85sm.py")  # 4:45 PM EST
    schedule.every().friday.at("22:00").do(run_script, script="85fm.py")  # 5:00 PM EST
    schedule.every().friday.at("22:15").do(run_script, script="85ad.py")  # 5:15 PM EST
