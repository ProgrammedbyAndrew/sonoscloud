...
#MONDAY
    ...
    schedule.every().wednesday.at("16:00").do(run_script, script="75fm.py")  # 11:00 AM EST
    schedule.every().wednesday.at("16:15").do(run_script, script="75sm.py")  # 11:15 AM EST
    schedule.every().wednesday.at("16:30").do(run_script, script="75fm.py")  # 11:30 AM EST
    schedule.every().wednesday.at("16:45").do(run_script, script="75sm.py")  # 11:45 AM EST
    schedule.every().wednesday.at("17:00").do(run_script, script="75fm.py")  # 12:00 PM EST
    schedule.every().wednesday.at("17:15").do(run_script, script="75sm.py")  # 12:15 PM EST
    schedule.every().wednesday.at("17:30").do(run_script, script="75fm.py")  # 12:30 PM EST
    schedule.every().wednesday.at("17:45").do(run_script, script="75sm.py")  # 12:45 PM EST
    schedule.every().wednesday.at("18:00").do(run_script, script="75fm.py")  # 1:00 PM EST
    schedule.every().wednesday.at("18:15").do(run_script, script="75sm.py")  # 1:15 PM EST
    schedule.every().wednesday.at("18:30").do(run_script, script="75fm.py")  # 1:30 PM EST
    schedule.every().wednesday.at("18:45").do(run_script, script="75sm.py")  # 1:45 PM EST
    schedule.every().wednesday.at("19:00").do(run_script, script="75fm.py")  # 2:00 PM EST
    schedule.every().wednesday.at("19:15").do(run_script, script="75sm.py")  # 2:15 PM EST
    schedule.every().wednesday.at("19:30").do(run_script, script="75fm.py")  # 2:30 PM EST
    schedule.every().wednesday.at("19:45").do(run_script, script="75sm.py")  # 2:45 PM EST
    schedule.every().wednesday.at("20:00").do(run_script, script="75fm.py")  # 3:00 PM EST
    schedule.every().wednesday.at("20:15").do(run_script, script="75sm.py")  # 3:15 PM EST
    schedule.every().wednesday.at("20:30").do(run_script, script="75fm.py")  # 3:30 PM EST
    schedule.every().wednesday.at("20:45").do(run_script, script="75sm.py")  # 3:45 PM EST
    schedule.every().wednesday.at("21:00").do(run_script, script="75fm.py")  # 4:00 PM EST
    schedule.every().wednesday.at("21:15").do(run_script, script="75sm.py")  # 4:15 PM EST
    schedule.every().wednesday.at("21:30").do(run_script, script="75fm.py")  # 4:30 PM EST
    ...
    schedule.every().thursday.at("22:15").do(run_script, script="75sm.py")  # 5:15 PM EST
    ...
    schedule.every().thursday.at("23:15").do(run_script, script="75sm.py")  # 6:15 PM EST
    ...
    schedule.every().friday.at("00:00").do(run_script, script="75fm.py")    # 7:00 PM EST
    ...
    schedule.every().friday.at("00:45").do(run_script, script="75sm.py")    # 7:45 PM EST
    ...
    schedule.every().friday.at("02:00").do(run_script, script="75fm.py")    # 9:00 PM EST
    schedule.every().friday.at("02:30").do(run_script, script="75sm.py")    # 9:30 PM EST
    schedule.every().friday.at("03:00").do(run_script, script="75sm.py")    # 10:00 PM EST
    schedule.every().friday.at("03:30").do(run_script, script="65sm.py")    # 10:30 PM EST
    schedule.every().friday.at("04:00").do(run_script, script="65sm.py")    # 11:00 PM EST
    schedule.every().friday.at("04:30").do(run_script, script="65sm.py")    # 11:30 PM
    schedule.every().friday.at("05:00").do(run_script, script="65sm.py")    # 12:00 AM
    ...
    schedule.every().friday.at("20:00").do(run_script, script="75fm.py")  # 3:00 PM EST
    schedule.every().friday.at("20:15").do(run_script, script="75sm.py")  # 3:15 PM EST
    schedule.every().friday.at("20:30").do(run_script, script="75fm.py")  # 3:30 PM EST
    schedule.every().friday.at("20:45").do(run_script, script="75sm.py")  # 3:45 PM EST
    schedule.every().friday.at("21:00").do(run_script, script="80fm.py")  # 4:00 PM EST
    schedule.every().friday.at("21:15").do(run_script, script="80sm.py")  # 4:15 PM EST
    schedule.every().friday.at("21:30").do(run_script, script="80fm.py")  # 4:30 PM EST
    schedule.every().friday.at("21:45").do(run_script, script="80sm.py")  # 4:45 PM EST
    schedule.every().friday.at("22:00").do(run_script, script="80fm.py")  # 5:00 PM EST
    schedule.every().friday.at("22:15").do(run_script, script="80sm.py")  # 5:15 PM EST
    schedule.every().friday.at("22:30").do(run_script, script="85fm.py")  # 5:30 PM EST
    schedule.every().friday.at("22:45").do(run_script, script="85fm.py")  # 5:45 PM EST
    schedule.every().friday.at("23:00").do(run_script, script="85fm.py")  # 6:00 PM EST
    schedule.every().friday.at("23:30").do(run_script, script="85sm.py")  # 6:30 PM EST
    ...
    schedule.every().saturday.at("00:30").do(run_script, script="80fm.py")  # 7:30 PM EST
    schedule.every().saturday.at("01:00").do(run_script, script="80fm.py")  # 8:00 PM EST
    schedule.every().saturday.at("01:30").do(run_script, script="80fm.py")  # 8:30 PM EST
    schedule.every().saturday.at("02:00").do(run_script, script="75fm.py")  # 9:00 PM EST
    schedule.every().saturday.at("02:30").do(run_script, script="75fm.py")  # 9:30 PM EST
    schedule.every().saturday.at("03:00").do(run_script, script="75sm.py")  # 10:00 PM EST
    schedule.every().saturday.at("03:30").do(run_script, script="75sm.py")  # 10:30 PM EST
    schedule.every().saturday.at("04:00").do(run_script, script="75sm.py")  # 11:00 PM EST
    schedule.every().saturday.at("04:30").do(run_script, script="75sm.py")  # 11:30 PM EST
    schedule.every().saturday.at("05:00").do(run_script, script="75sm.py")  # 12:00 AM EST
    ...
    schedule.every().saturday.at("06:30").do(run_script, script="65sm.py")  # 1:30 AM EST
    ...
    schedule.every().saturday.at("19:30").do(run_script, script="75fm.py")  # 14:30 EST
    ...
    schedule.every().saturday.at("20:30").do(run_script, script="75fm.py")  # 15:30 EST
    ...
    schedule.every().saturday.at("21:30").do(run_script, script="75fm.py")  # 16:30 EST
    ...
    schedule.every().saturday.at("22:30").do(run_script, script="80fm.py")  # 17:30 EST
    ...
    schedule.every().saturday.at("23:30").do(run_script, script="85fm.py")  # 18:30 EST
    ...
    schedule.every().sunday.at("00:30").do(run_script, script="85fm.py")    # 19:30 EST
    ...
    schedule.every().sunday.at("01:30").do(run_script, script="85sm.py")    # 20:30 EST
    ...
    schedule.every().sunday.at("02:30").do(run_script, script="80fm.py")    # 21:30 EST
    ...
    schedule.every().sunday.at("04:00").do(run_script, script="75sm.py")    # 23:00 EST
    ...
    schedule.every().sunday.at("05:15").do(run_script, script="85sm.py")    # 00:15 EST
    ...
    schedule.every().sunday.at("06:00").do(run_script, script="85sm.py")    # 01:00 EST
    ...
    schedule.every().sunday.at("16:00").do(run_script, script="75fm.py")  # 11:00 AM EST
    schedule.every().sunday.at("16:15").do(run_script, script="75sm.py")  # 11:15 AM EST
    schedule.every().sunday.at("16:30").do(run_script, script="75fm.py")  # 11:30 AM EST
    schedule.every().sunday.at("16:45").do(run_script, script="75sm.py")  # 11:45 AM EST
    schedule.every().sunday.at("17:00").do(run_script, script="75fm.py")  # 12:00 PM EST
    schedule.every().sunday.at("17:15").do(run_script, script="75sm.py")  # 12:15 PM EST
    schedule.every().sunday.at("17:30").do(run_script, script="75fm.py")  # 12:30 PM EST
    schedule.every().sunday.at("17:45").do(run_script, script="75sm.py")  # 12:45 PM EST
    schedule.every().sunday.at("18:00").do(run_script, script="75fm.py")  # 1:00 PM EST
    ...
    schedule.every().sunday.at("20:15").do(run_script, script="85sm.py")  # 3:15 PM EST
    ...
    schedule.every().sunday.at("22:00").do(run_script, script="80sm.py")  # 5:00 PM EST
    schedule.every().sunday.at("22:30").do(run_script, script="75sm.py")  # 5:30 PM EST
    schedule.every().sunday.at("23:00").do(run_script, script="70fm.py")  # 6:00 PM EST
    ...
    schedule.every().monday.at("01:30").do(run_script, script="65fm.py")  # 8:30 PM EST
    ...
    schedule.every().monday.at("03:30").do(run_script, script="85sm.py")  # 10:30 PM EST
    schedule.every().monday.at("04:00").do(run_script, script="70sm.py")  # 11:00 PM EST
    schedule.every().monday.at("04:30").do(run_script, script="70sm.py")  # 11:30 PM EST
    schedule.every().monday.at("05:00").do(run_script, script="70sm.py")  # 12:00 AM EST
    schedule.every().monday.at("05:15").do(run_script, script="70sm.py")  # 12:15 AM EST
    schedule.every().monday.at("05:30").do(run_script, script="65sm.py")  # 12:30 AM EST
    schedule.every().monday.at("05:45").do(run_script, script="65sm.py")  # 12:45 AM EST
