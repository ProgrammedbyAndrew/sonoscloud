...
#MONDAY
    ...
    schedule.every().friday.at("20:00").do(run_script, script="75ad.py")  # 3:00 PM EST
    ...
    schedule.every().friday.at("21:15").do(run_script, script="80ad.py")  # 4:15 PM EST
    ...
    schedule.every().friday.at("22:15").do(run_script, script="80ad.py")  # 5:15 PM EST
    ...
    schedule.every().saturday.at("01:30").do(run_script, script="80ad.py")  # 8:30 PM EST
    ...
    schedule.every().saturday.at("03:30").do(run_script, script="75ad.py")  # 10:30 PM EST
