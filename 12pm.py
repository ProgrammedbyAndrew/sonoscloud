...
# Load and play the first favorite playlist at volume 90
favorite_playlist_id_1 = "1"
desired_volume_1 = 90
...
# Wait for 8 seconds before proceeding
print("Waiting 8 seconds before playing the next playlist...")
time.sleep(8)

# Load and play the second favorite playlist at volume 80
favorite_playlist_id_2 = "0"
desired_volume_2 = 70
